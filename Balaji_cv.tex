...
\makecvtitle
\section{Experience:}
\cvitem{Redtree.AI: An LLM-Approach To Tutoring Students with Nehal Gajraj}{I finetuned LLama3 8B on various educational datasets and evaluated on various benchmarks. Also I worked on reproducing the results of using monte carlo tree search to get comparable performance on grade-school and olympiad math benchmarks from LLama3-8B as GPT-4}
\section{Projects:}
